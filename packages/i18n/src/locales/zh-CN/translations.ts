...
export default {
  ...
  power_k: {
    contextual_actions: {
      work_item: {
        ...
        copy_url_toast_error: "复制工作项链接到剪贴板时发生错误。",
      },
      cycle: {
        title: "周期操作",
        indicator: "周期",
        ...
        copy_url_toast_error: "复制周期链接到剪贴板时发生错误。",
      },
      module: {
        title: "模块操作",
        indicator: "模块",
        ...
        copy_url_toast_error: "复制模块链接到剪贴板时发生错误。",
      },
      page: {
        title: "页面操作",
        indicator: "页面",
        ...
        copy_url_toast_error: "复制页面链接到剪贴板时发生错误。",
      },
    },
    creation_actions: {
      create_work_item: "新工作项",
      create_page: "新页面",
      create_view: "新视图",
      create_cycle: "新周期",
      create_module: "新模块",
      create_project: "新项目",
      create_workspace: "新工作区",
    },
    navigation_actions: {
    ...
    miscellaneous_actions: {
      ...
      copy_current_page_url_toast_error: "复制当前页面链接到剪贴板时发生错误。",
  ...
  settings_description: "在一个地方集中管理您的账户、工作区和项目偏好设置。切换标签页即可轻松配置。",
  settings_moved_to_preferences: "时区和语言设置已移至偏好设置。",
  show_limited_projects_on_sidebar: "在侧边栏显示数量受限的项目",
